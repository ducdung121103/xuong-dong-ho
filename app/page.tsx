        ...
        <div className="mx-auto max-w-4xl space-y-4">
          ...
          <div className="flex gap-2 items-end">
            <textarea
              ...
              rows={3}
              placeholder="Mô tả ý tưởng của bạn... Ví dụ: con lợn trong rừng tre, phong cách Tết"
              className="flex-1 resize-none rounded-lg border border-border bg-background px-4 py-3 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-50"
              disabled={loading}
            />
            <Button
              onClick={() => handleSendMessage()}
              disabled={loading || !input.trim()}
              className="bg-primary text-primary-foreground hover:bg-primary/90 stamp-press h-10 w-10 flex shrink-0 items-center justify-center"
              size="icon"
            >
