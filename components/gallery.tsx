        ...
        <div className="mt-12 flex justify-center">
          <Link
            ...
            className={cn(
              ...
              "border-[#C49A5C]/40 text-[#C49A5C] hover:bg-[#C49A5C]/10 hover:text-[#C49A5C] border-2 cursor-pointer transition-colors px-6 py-5 rounded-lg text-sm font-semibold stamp-press animate-bounce-subtle"
            )}
          >
