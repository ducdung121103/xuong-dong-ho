    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="#" className="flex items-center gap-2.5">
          ...
          <span className="font-serif text-lg font-700 tracking-tight text-foreground">
            Xưởng Đông Hồ
          </span>
        </a>
          ...
          <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-6 py-4" aria-label="Điều hướng di động">
            {navLinks.map((link) => (
              <a
                ...
                className="rounded-md px-3 py-2.5 text-sm font-500 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
              >
                {link.label}
              </a>
            ))}
