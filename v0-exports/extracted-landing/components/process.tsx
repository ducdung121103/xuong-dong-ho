        ...
        <div className="stamp-press mt-14 overflow-hidden rounded-2xl border border-secondary/30 bg-background shadow-[0_1px_0_rgba(176,124,48,0.15)]">
          ...
          <div className="grid gap-px bg-border md:grid-cols-[1.4fr_1fr]">
              ...
              {steps.map((step) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-serif text-2xl font-700 text-border transition-colors group-hover:text-secondary/40">
                      {step.no}
                    </span>
                  </div>
                  <h3 className="font-serif text-base font-600 text-foreground">
                    {step.title}
                  </h3>
            ...
            <div className="flex flex-col items-center justify-center gap-5 bg-background p-8 text-center">
              ...
              >
                <span className="flex items-center gap-2 font-serif text-base font-700 leading-tight text-balance">
                  Kích Hoạt Quy Trình Khắc Ấn Đa Lớp
                  <ArrowRight className="size-4 shrink-0 transition-transform group-hover:translate-x-0.5" />
                </span>
                <span className="text-xs font-500 opacity-80">
