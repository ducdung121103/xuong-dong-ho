    ...
    <aside className="flex w-[320px] shrink-0 flex-col border-r border-[rgba(176,124,48,0.15)] bg-[#1E1C1A]">
      ...
      <div className="border-b border-[rgba(176,124,48,0.15)] p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[rgba(176,124,48,0.2)] bg-[#121110] py-2.5 pl-9 pr-3 text-sm text-[#EADABF] placeholder:text-[#A99672] focus:border-[#B07C30] focus:outline-none"
          />
        </div>
      </div>
      ...
      {mode === "ai" ? (
        <div className="flex flex-1 flex-col items-center justify-center gap-3 p-6 text-center">
          <span className="flex size-12 items-center justify-center rounded-full bg-[#B07C30]/15 text-[#B07C30]">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {filtered.map((m, i) => (
                <button
                  ...
                  className="motif-card group flex aspect-square flex-col items-center justify-center gap-1.5 rounded-lg border border-[rgba(176,124,48,0.15)] bg-[#1E1C1A] transition-all hover:border-[#B07C30]"
                >
