...
const SWATCHES = [
  { hex: "#B33E2B", name: "Đỏ Son" },
  { hex: "#B07C30", name: "Vàng Hòe" },
  { hex: "#265C41", name: "Xanh Lục" },
  { hex: "#583220", name: "Nâu Gụ" },
  { hex: "#D0898B", name: "Hồng Sen Trầm" },
  { hex: "#507C6F", name: "Xanh Ngọc" },
  { hex: "#121110", name: "Đen Than Xoan" },
  { hex: "#F4E7D3", name: "Trắng Điệp" },
]
...
function Section({
  ...
  return (
    <section className="border-b border-[rgba(176,124,48,0.15)] p-4">
      <h3 className="mb-3 font-mono text-[11px] font-semibold uppercase tracking-wider text-[#B07C30]">
        {title}
      </h3>
      {children}
    </section>
