  ...
  return (
    <section id="cta" className="border-y border-border bg-card">
      <div className="mx-auto max-w-4xl px-6 py-20 text-center md:py-28">
        ...
        <h2 className="mx-auto mt-3 max-w-2xl font-serif text-3xl font-bold leading-tight tracking-tight text-balance text-foreground woodcut-text sm:text-4xl lg:text-5xl">
